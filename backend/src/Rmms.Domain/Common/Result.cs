...
/// <summary>
/// Result pattern — "errors as data" per project coding principle #7.
/// Use when a method can fail in expected, business-meaningful ways.
/// For truly exceptional cases (DB down, OOM), still throw exceptions.
/// </summary>
public class Result
{
