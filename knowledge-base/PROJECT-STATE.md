...
**Current phase:** Phase 1A — **Sprint 01 (M01 Auth & Devices), Week 2 in progress — Day 6 (BE) + Day 7 (FE-W user mgmt + BE refresh-reuse tests) ✅ done; next Day 8 (i18n/resx + Serilog enrichment)**
