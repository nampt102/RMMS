...
export default function AdminLayout({
  ...
  const allItems = [
    ...
    { key: `/${locale}/visit-plans`, icon: <EnvironmentOutlined />, label: <Link href={`/${locale}/visit-plans`}>{t("navVisitPlans")}</Link>, roles: ["admin"] },
    ...
    { key: `/${locale}/documents`, icon: <FolderOpenOutlined />, label: <Link href={`/${locale}/documents`}>{t("navDocuments")}</Link>, roles: ["admin"] },
    { key: `/${locale}/news`, icon: <NotificationOutlined />, label: <Link href={`/${locale}/news`}>{t("navNews")}</Link>, roles: ["admin"] },
    { key: `/${locale}/reports`, icon: <LineChartOutlined />, label: <Link href={`/${locale}/reports`}>{t("navReports")}</Link>, roles: ["admin"] },
